                    ...
                    <div class="card-body">
                        <div id="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md col-lg">
                                    <label class="form-control-label">Delivery Cost Discount: <span
                                            class="tx-danger">*</span></label>
                                    <input class="form-control" id="delivery_cost_discount" name="delivery_cost_discount"
                                        placeholder="Enter Plus Delivery Cost" required type="number" value="<?php echo e($user->delivery_cost_discount); ?>">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u447710865/domains/jaberandrabiacompanyforlogistics.com/resources/views/users/edit.blade.php ENDPATH**/ ?>