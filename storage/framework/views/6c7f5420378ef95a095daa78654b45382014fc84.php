...
<head>
    ...
    <!-- TITLE -->
    <title>Ultra Palestine - Login</title>
            ...
            <div class="">
                ...
                <div class="container-login100">
                    <div class="wrap-login100 p-6">
                        ...
                        <form class="login100-form validate-form" action="<?php echo e(route('dologin')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab5">
                                            ...
                                            <div class="text-center pt-3">
                                                <p class="text-dark mb-0">Not a member?<a href="<?php echo e(route('register')); ?>"
...
<?php /**PATH /home/u447710865/domains/jaberandrabiacompanyforlogistics.com/resources/views/auth/login.blade.php ENDPATH**/ ?>