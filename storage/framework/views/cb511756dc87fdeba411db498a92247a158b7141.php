    ...
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="POST" action="<?php echo e(route('villages.update',$village->id)); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div id="">
                            <div class="row ">
                                <div class="col-md-6 col-lg-6 m-auto">
                                    ...
                                    <select name="area_id" id="area"
                                        ...
                                        <?php $__currentLoopData = App\Models\Area::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($area->id); ?>" <?php if($area->id == $village->area_id): ?>
                                                selected
                                            <?php endif; ?>><?php echo e($area->area_name); ?></option>
                                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6 m-auto">
                                    ...
                                    <input class="form-control" id="village" name="village_name"
                                        placeholder="Enter Village Name" required="" type="text" value="<?php echo e($village->village_name); ?>">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-md-6 col-lg-6 m-auto">
                                    ...
                                    <input class="form-control" id="delivery_cost" name="delivery_cost"
                                        placeholder="Enter Deliver Cost" required="" type="number" value="<?php echo e($village->delivery_cost); ?>">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u447710865/domains/jaberandrabiacompanyforlogistics.com/resources/views/villages/edit.blade.php ENDPATH**/ ?>