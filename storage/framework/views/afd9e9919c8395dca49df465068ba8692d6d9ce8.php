                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="mt-2">
                                    <h6 class=""><?php echo e($office->office_name); ?></h6>
                                    <h2 class="mb-0 number-font"><?php echo e($office->budget); ?> <i class="fas fa-shekel-sign"></i></h2>
                                </div>
                                <div class="ms-auto">
                                    <div class="chart-wrapper mt-1">
                                        <canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
...
<!-- ROW-1 END -->
<?php /**PATH /home/u447710865/domains/jaberandrabiacompanyforlogistics.com/resources/views/layouts/cards.blade.php ENDPATH**/ ?>