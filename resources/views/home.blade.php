...
<head>
    ...
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="{{asset('siteAssets/css/theme.css')}}">
			    ...
			    <div class="col-12 col-md-6 pt-3 pt-md-4">
				    ...
				    <div class="cta-btns">
					    <ul class="app-stores list-unstyled list-inline mx-auto mx-md-0 d-inline-block">
						    <li class="list-inline-item me-3"><a href="#"><img class="ios" src="{{asset('siteAssets/images/appstore-apple.svg')}}" alt="app-store"></a></li>
						    <li class="list-inline-item"><a href="#"><img class="android" src="{{asset('siteAssets/images/appstore-android.svg')}}" alt="google play"></a></li>
					    </ul>
				    </div>
			    </div>
		    </div><!--//row-->
		    ...
		    <div class="row">
		        <div class="item col-12 col-lg-4">
				    <div class="item-inner text-center p-3 p-lg-5">
					    <img class="mb-3" src="{{asset('siteAssets/images/icon-target.svg')}}" alt="" />
			    ...
			    <div class="item col-12 col-lg-4">
				    <div class="item-inner text-center p-3 p-lg-5">
					    <img class="mb-3" src="{{asset('siteAssets/images/icon-rocket.svg')}}" alt="" />
			    ...
			    <div class="item col-12 col-lg-4">
				    <div class="item-inner text-center p-3 p-lg-5">
					    <img class="mb-3" src="{{asset('siteAssets/images/icon-cogs.svg')}}" alt="" />
	    ...
	    <div class="container py-lg-5 position-relative">
		    ...
		    <div class="row pt-5 mb-5">
			    ...
			    <div class="col-12 col-md-6 col-xl-5 offset-xl-1 d-none d-md-block">
				    <img class="product-figure product-figure-1 img-fluid" src="{{asset('siteAssets/images/product-figure-1.png')}}" alt="" />
			    </div>
	        ...
	        <div id="testimonial-carousel" class="testimonial-carousel">
			    <div class="carousel-cell">
				    <div class="item-inner shadow rounded">
					    ...
					    <div class="source row">
						    <div class="col-auto">
						        <img class="source-profile rounded-circle" src="{{asset('siteAssets/images/users/user-1.jpg')}}" alt="" />
					        </div><!--//col-->
			    ...
			    <div class="carousel-cell">
				    <div class="item-inner shadow rounded">
					    ...
					    <div class="source row">
						    <div class="col-auto">
						        <img class="source-profile rounded-circle" src="{{asset('siteAssets/images/users/user-2.jpg')}}" alt="" />
						    </div>
						    <div class="source-info col pt-3">
							    <div>Helen Owens</div>
							    <div>New York, US</div>
			    ...
			    <div class="carousel-cell">
				    <div class="item-inner shadow rounded">
					    ...
					    <div class="source row">
						    <div class="col-auto">
						        <img class="source-profile rounded-circle" src="{{asset('siteAssets/images/users/user-3.jpg')}}" alt="" />
						    </div>
						    <div class="source-info col pt-3">
			    ...
			    <div class="carousel-cell">
				    <div class="item-inner shadow rounded">
					    ...
					    <div class="source row">
						    <div class="col-auto">
						        <img class="source-profile rounded-circle" src="{{asset('siteAssets/images/users/user-4.jpg')}}" alt="" />
						    </div>
						    <div class="source-info col pt-3">
			    ...
			    <div class="carousel-cell">
				    <div class="item-inner shadow rounded">
					    ...
					    <div class="source row">
						    <div class="col-auto">
						        <img class="source-profile rounded-circle" src="{{asset('siteAssets/images/users/user-5.jpg')}}" alt="" />
						    </div>
						    <div class="source-info col pt-3">
			    ...
			    <div class="carousel-cell">
				    <div class="item-inner shadow rounded">
					    ...
					    <div class="source row">
						    <div class="col-auto">
						        <img class="source-profile rounded-circle" src="{{asset('siteAssets/images/users/user-6.jpg')}}" alt="" />
						    </div>
						    <div class="source-info col pt-3">
							    <div>Tony Cheng</div>
							    <div>San Francisco, US</div>
			    ...
			    <div class="carousel-cell">
				    <div class="item-inner shadow rounded">
					    ...
					    <div class="source row">
						    <div class="col-auto">
						        <img class="source-profile rounded-circle me-3" src="{{asset('siteAssets/images/users/user-7.jpg')}}" alt="" />
						    </div>
						    <div class="source-info col pt-3">
