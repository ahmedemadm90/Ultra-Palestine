    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="{{route('dashboard')}}">
                <img src="{{ asset('assets/images/brand/logo.png') }}" class="header-brand-img desktop-logo w-10"
                    alt="logo">
                <img src="{{ asset('assets/images/brand/logo.png') }}" class="header-brand-img light-logo1 w-10"
                    alt="logo">
            </a>
            <!-- LOGO -->
                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown d-flex profile-1">
                                <a href="javascript:void(0)" data-bs-toggle="dropdown"
                                    ...
                                    <img src="{{ asset('media/users/profiles/'.auth()->user()->image) }}" alt="profile-user"
                                        class="avatar  profile-user brround cover-image">
                                    @else
                                    <img src="{{ asset('assets/images/users/temp.png') }}" alt="profile-user"
                                        class="avatar  profile-user brround cover-image">
                                    @endif
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading">
                                        <div class="text-center">
                                            <h5 class="text-dark mb-0 fs-14 fw-semibold">{{ auth()->user()->fname }}
                                                {{ auth()->user()->lname }}</h5>
