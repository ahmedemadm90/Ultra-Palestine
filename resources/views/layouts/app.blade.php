...
<head>
    ...
    <!-- TITLE -->
    <title>Ultra Palestine - @yield('title')</title>
    ...
    <link href="a{{ asset('ssets/css/transparent-style.css') }}" rel="stylesheet">
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">@yield('bage-header')</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">@yield('bage-header')</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
