    ...
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="POST" action="{{ route('villages.update',$village->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div id="">
                            <div class="row ">
                                <div class="col-md-6 col-lg-6 m-auto">
                                    ...
                                    <select name="area_id" id="area"
                                        ...
                                        @foreach (App\Models\Area::all() as $area)
                                            <option value="{{ $area->id }}" @if ($area->id == $village->area_id)
                                                selected
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6 m-auto">
                                    ...
                                    <input class="form-control" id="village" name="village_name"
                                        placeholder="Enter Village Name" required="" type="text" value="{{$village->village_name}}">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-md-6 col-lg-6 m-auto">
                                    ...
                                    <input class="form-control" id="delivery_cost" name="delivery_cost"
                                        placeholder="Enter Deliver Cost" required="" type="number" value="{{$village->delivery_cost}}">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
